...
export const photoNarrativeByFile = {
  '35.jpg': {
    subtitle: '故事的起點',
    body: '那時我在日本旅遊，透過 Pairs 派愛族交友軟體和妳搭上話。為了約妳出來見面，我主動幫妳代購 Yosistamp，這個小小的契機，成了我們故事的起點。',
  ...
  '26.jpg': {
    subtitle: '青青草原與豆腐岩',
    body: '我們一起在青青草原奔跑、拍照，感受大自然的寬闊。接著到頭前溪豆腐岩散步，跳在石頭上的每一步都很開心。有妳陪伴，風景都變得特別美好。',
  ...
  '32.jpg': {
    subtitle: '合興車站與薰衣草森林',
    body: '我們一起到合興車站拍照、寫下幸福的紀念，再到薰衣草森林散步，空氣裡都是花香和妳的笑聲。這一天的浪漫，因妳而特別難忘。',
  ...
  '31.jpg': {
    subtitle: '香山螃蟹步道',
    body: '一起在香山螃蟹步道散步，看潮間帶的風景和小螃蟹。妳的笑聲和海風一樣清爽，這段自然裡的時光，讓人一直想再回味。',
  ...
  '34.jpg': {
    subtitle: '迪士尼100週年特展',
    body: '一起到台北中正紀念堂看迪士尼100週年特展，經典角色和童年回憶都在眼前重現。妳的笑容和展覽裡的魔法一樣，讓這一天變得特別夢幻又快樂。',
  ...
  '30.jpg': {
    subtitle: '生活美學館與阿忠冰店',
    body: '一起去新竹生活美學館散步，感受藝術與靜謐。後來到阿忠冰店吃冰，聽我說爸媽年輕時也在這裡約會。這份跨世代的回憶，因妳的陪伴而更有溫度。',
  ...
  '29.jpg': {
    subtitle: '小森之歌・落羽松',
    body: '一起到小森之歌散步，看落羽松的綠意和倒影。妳的笑容和樹影一樣溫柔，這段靜靜走過的時光，讓心情也變得很平靜。',
  ...
  '33.jpg': {
    ...
    body: '和妳、還有妹妹三人一起到雄獅文具想像力製造所，動手做彩繪零錢包、製作彩色筆。創作的過程裡有笑聲、有驚喜，這種一起動手的時光，讓回憶變得特別有趣又溫馨。',
  ...
  '28.jpg': {
    subtitle: '空拍初體驗',
    body: '妳第一次嘗試操作空拍機，我在旁邊一步步教妳。看著妳專注又新奇的表情，覺得這個小小的初體驗特別有趣。和妳一起學習、一起記錄天空的畫面，是很珍貴的回憶。',
  ...
  '27.jpg': {
    subtitle: '福湯岩盤浴',
    body: '一起去福湯岩盤浴放鬆，享受溫暖的石板和靜靜的時光。妳靠在我身邊的樣子，讓這份平靜變得特別幸福。',
  ...
  '36.jpg': {
    subtitle: '旭集生日大餐',
    body: '2024年女友生日，我們特地去旭集享用高級日式吃到飽。每一道料理都很精緻，妳吃得開心，我也覺得很幸福。能在這樣特別的日子陪妳大快朵頤，是我最想給妳的溫柔與儀式感。',
  ...
  '37.jpg': {
    ...
    body: '交往兩周年的紀念日，餐廳帳單上竟然寫著「結婚周年招待蛋糕」，讓我忍不住笑了一下。雖然只是小小的誤會，卻讓這個紀念日多了一份特別的甜蜜和回憶。',
