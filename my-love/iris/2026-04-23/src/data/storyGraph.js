...
const photoNarrativeByFile = {
  ...
  '7.png': {
    subtitle: '花之舞光影展，光落在妳眼裡。',
    body: '色彩一層一層流動，妳站在光裡像一幅會呼吸的畫。\n我只想把這個畫面，偷偷收藏很久很久。',
    caption: '光影流轉，妳的身影在燈光下格外溫柔。'
  },
  '8.png': {
    subtitle: '櫻花樹下，春天剛好也在。',
    body: '花雨落在肩上，我們慢慢走，沒有人催促。\n這一幕很輕，卻把幸福說得很完整。',
    caption: '櫻花樹下，妳的笑容比花還燦爛。'
  },
  '9.png': {
  ...
  '10.png': {
    ...
    body: '妳在展區裡笑得像小朋友，我也跟著幼稚起來。\n那天沒有偉大道理，只有很真實的開心。',
    caption: '和自嘲熊合影的瞬間，童心與可愛讓我們一起大笑。'
  },
  '11.png': {
    subtitle: '竹北燈會的夜，被妳點亮。',
    body: '燈海很漂亮，但我最常看的還是妳的側臉。\n人潮再多，妳靠近我時世界就安靜了。',
